...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Before swimming, wet your hair with fresh water — saturated hair absorbs less chlorine. Apply a leave-in conditioner or coconut oil through the lengths and ends as a protective barrier. Wear a swim cap if you\'re in the pool regularly. Rinse immediately after swimming and follow with a clarifying shampoo and deep conditioning mask.',
      },
      {
    ...
    faqs: [
      ...
      { q: 'What causes green tones in blonde hair after swimming?', a: 'Chlorine oxidizes copper deposits in pool water, which then bond to the hair. This is most visible in blonde hair. A clarifying shampoo immediately after swimming prevents buildup. For existing green tones, a tomato sauce or ketchup treatment is an old folk remedy — ask your colorist for a professional recommendation.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Can I color hair extensions?', a: 'Human Remy hair extensions can be toned or lightly darkened, but significant lightening (bleaching) is not recommended — it damages the hair\'s cuticle permanently. Always consult your Blend extension specialist before any color on extensions.' },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Warm honey tones — amber, caramel, and golden blonde — are universally flattering and look especially beautiful in South Florida\'s year-round sunlight. A warm honey balayage hand-painted through medium to dark brown hair creates the appearance of natural sun-lightening. It grows out softly, doesn\'t require frequent touch-ups, and works on a wide range of skin tones.',
      },
      {
      ...
      },
      {
        ...
        body: 'Copper and auburn shades have had a significant moment in recent years, and they\'re particularly striking in South Florida\'s warm light. They work beautifully on medium to dark hair as an all-over color or through a balayage technique. Note that red tones fade faster than other shades — plan for a toning gloss every 6–8 weeks.',
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'On dark hair, the contrast between root and highlighted ends makes tone choice especially visible and important. Warm tones — caramel, honey, golden amber, and copper — tend to be most universally flattering on a wide range of skin tones and are particularly gorgeous against deeper skin tones, where warmth in the hair echoes and complements the skin\'s undertone. Cool and ashy tones look stunning on clients with pink or neutral skin undertones but require more toning maintenance on dark base hair because the hair\'s natural warmth fights cool tones. Your colorist at Blend will assess your skin tone and make a specific recommendation.',
      },
      {
    ...
    faqs: [
      ...
      { q: 'What balayage tone looks best on dark skin?', a: 'Warm tones — caramel, golden honey, copper, and amber — tend to be most flattering against deeper and darker skin tones. They echo the natural warmth in the skin beautifully. Cool ashy blondes require more maintenance against dark base hair and may need more sessions to achieve.' },
      { q: 'How long does balayage on dark hair last?', a: 'The lightened sections are permanent — the actual lightening does not fade. The tone shifts over weeks as toner washes out. Most dark-hair balayage clients schedule a toning gloss every 8–10 weeks and a full refresh every 3–4 months.' },

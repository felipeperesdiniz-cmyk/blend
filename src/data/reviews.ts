...
export const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    stylist: 'Nana',
    quote: 'My hair professional is Nana Reis, and she is amazing! From start to finish she is professional, attentive, and truly passionate about her work. She executed the color and blowout flawlessly. The end result exceeded my expectations.',
    stars: 5,
    source: 'Yelp',
  },
  {
    ...
    stylist: 'Lea',
    quote: 'I got my hair cut before an event and Lea understood the assignment and gave me the fresh layered look I\'ve been looking for. Worth every dollar.',
    stars: 5,
    source: 'Yelp',
  },
  {

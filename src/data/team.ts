...
export const TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    name: 'Léa Araujo',
    specialty: 'Master Stylist',
    bio: 'Originally from Brazil and with Blend for over six years, Léa is known for her expertise in hair color, especially blondes, plus precision curly cuts, and hair extensions.',
    languages: 'English, Portuguese',

...
export const metadata: Metadata = {
  ...
  description:
    `A Brazilian-owned luxury hair salon in Plantation, Florida: Brazilian blowouts, keratin treatments, balayage and color. 4.9★ · ${REVIEW_COUNT}+ reviews.`,
  alternates: hreflang('/brazilian-hair-salon-plantation-fl', 'en'),
  openGraph: {
    images: [OG_IMAGE],
    title: 'Brazilian Hair Salon in Plantation, FL | Blend Hair Boutique',
    description:
      'Brazilian-owned luxury hair salon in Plantation, FL. Expert Brazilian blowouts, keratin, balayage, and color by Brazilian beauty professionals. Book online.',
    url: CANONICAL,
  },
}
        ...
        <header className="page-hero page-hero--dark">
          <div className="container hero-layer">
            ...
            <p style={{ fontFamily: 'var(--sans)', fontSize: 'clamp(1rem, 1.4vw, 1.1rem)', color: 'rgba(255,255,255,0.8)', lineHeight: 1.75, maxWidth: '52ch', marginTop: '1.5rem', fontWeight: 300 }}>
              Blend Hair Boutique brings the artistry and warmth of Brazilian beauty culture to the heart of South Florida. Our Brazilian co-founders and their team of professionals deliver the full range of Brazilian hair techniques, from our signature blowout to customized color and smoothing treatments.
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'clamp(3rem, 6vw, 5rem)', alignItems: 'center' }}>
              <div>
                ...
                <p style={{ fontSize: '1rem', lineHeight: 1.85, color: 'var(--text-2)', fontWeight: 300, marginBottom: '1rem' }}>
                  Blend Hair Boutique was founded in 2017 by Juliana Chen, alongside co-owner and salon manager Fernanda Macedo, Brazilian beauty professionals who relocated to Florida with a shared mission: to make the full Brazilian salon experience accessible to South Florida clients.
                </p>

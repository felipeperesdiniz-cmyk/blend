...
export const metadata: Metadata = {
  ...
  description:
    'Blend Hair Boutique is a Brazilian-owned luxury hair salon in Plantation, Florida. Specializing in Brazilian blowouts, keratin treatments, balayage, and hair color. 4.9★ · 1,218 reviews.',

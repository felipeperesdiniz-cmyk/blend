...
export const metadata: Metadata = {
  ...
  description:
    'Professional makeup application in Plantation, Florida — bridal makeup, event makeup, and everyday glam at Blend Hair Boutique. 4.9★ · 1,218 reviews. Book your makeup appointment online.',

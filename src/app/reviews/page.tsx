...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'I\'ve been coming to Blend for two years and will not go anywhere else. Beatriz transformed my hair from a box dye disaster to the most beautiful balayage. She took time to understand exactly what I wanted and delivered beyond my expectations. The salon is gorgeous, clean, and everyone is so welcoming.',
  },
  {
    name: 'Maria L.',
    service: 'Keratin Treatment',
    rating: 5,
    text: 'I\'ve lived in South Florida my whole life and always struggled with humidity frizz. Roger did my Brazilian blowout and it lasted nearly 5 months. I\'ve had keratin treatments elsewhere and nothing compares to the results I get at Blend. Professional, knowledgeable, and worth every dollar.',
  },
  {
    name: 'Jessica T.',
    service: 'Highlights & Color',
    rating: 5,
    text: 'Debora is a true artist. I brought a photo of the highlights I wanted and she matched it perfectly — actually better than the photo. My hair was done in about 3 hours and came out so healthy and shiny. I\'ve been recommending Blend to everyone I know.',
  },
  {
    name: 'Amanda G.',
    service: 'Bridal Hair & Makeup',
    rating: 5,
    text: 'I had my wedding hair and makeup done at Blend and the entire team was incredible. From the trial to the day-of styling, everything was smooth, relaxed, and professional. My hair held all night in the Florida heat. My whole bridal party came with me and we all left feeling like the best versions of ourselves.',
  },
  {
    name: 'Camila S.',
    service: 'Manicure & Pedicure',
    rating: 5,
    text: 'I always combine a mani-pedi with my hair appointment. The nail technicians are so precise and the gel manicure always lasts over 3 weeks. The whole experience from the moment you walk in — the music, the smell, the atmosphere — feels like a true luxury salon.',
  },
  {
    name: 'Sofia M.',
    service: 'Hair Extensions',
    rating: 5,
    text: 'Léa installed my tape-in extensions and I cannot say enough great things. They look completely natural, blend perfectly with my real hair, and she gave me detailed instructions on how to care for them at home. Blend is not just a salon — it\'s an experience.',
  },
  {
    name: 'Karen O.',
    service: 'Haircut & Blowout',
    rating: 5,
    text: 'First time at Blend and I am absolutely coming back. My stylist listened carefully to what I wanted, gave me her honest opinion on what would look best, and delivered a cut that I\'ve been getting compliments on for weeks. The blowout alone was worth it.',
  },
  {
    name: 'Patricia F.',
    service: 'Facial & Waxing',
    rating: 5,
    text: 'I had a hydrating facial followed by eyebrow waxing. My skin looked completely transformed — glowing, smooth, and so refreshed. The esthetician was gentle with my sensitive skin and used products that didn\'t cause any irritation. Already booked my next appointment.',
  },
  {
    name: 'Laura C.',
    service: 'Color Correction',
    rating: 5,
    text: 'I came in with a box dye situation that I was embarrassed about. The colorist was kind, non-judgmental, and incredibly skilled. Over two sessions, she corrected my color completely — my hair now looks better than it ever has. I trust Blend completely.',
  },
]

...
const faqs = [
  ...
  },
  {
    ...
    a: 'Blend Hair Boutique is open Monday through Friday 9:00 AM to 7:00 PM, Saturday 9:00 AM to 7:00 PM, and closed on Sunday. Hours may vary on holidays — we recommend checking our booking system or calling (754) 206-3501 to confirm availability.',
  },
  {
          ...
          <div className="container">
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '2rem', justifyContent: 'center', alignItems: 'center' }}>
              {[
                ...
                <span key={item} style={{ fontSize: '0.82rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--text-2)', fontWeight: 500 }}>{item}</span>
              ))}
            </div>
          </div>
        </section>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '1.5rem' }}>
              {services.map((s) => (
                ...
                >
                  ...
                  <span style={{ display: 'inline-block', marginTop: '0.75rem', fontSize: '0.8rem', color: 'var(--gold)', letterSpacing: '0.1em', fontWeight: 500 }}>Learn more →</span>
                </Link>
              ))}
            </div>
          </div>
